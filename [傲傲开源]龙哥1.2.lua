gg.toast(os.date("🛡龙哥正在保护你的脚本🛡 "))
 ...
 function YY998() gg.playMusic("http://www.ihaoge.net/kw/antiserver.kuwo.cn/anti.s?rid=MUSIC_165397002&response=res&format=mp3|aac&type=convert_url&br=128kmp3&agent=iPhone&callback=getlink&jpcallback=getlink.mp3") end   ----音乐外链
