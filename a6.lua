...
a = io.open("/sdcard/星辰阁配置文件.txt", "rb") if a == nil then user = "" pass = "" else
a = io.open("/sdcard/星辰阁配置文件.txt"):read("*a") lq = a:match("✔️(.-)✔️") if a == "" then zh = "" end end
 dI=gg.prompt({"🐬输入你的迷你号🐬","星辰推荐音乐❤️"},{[1] = lq,[2] = nil},{[1] = "number",[2] = "checkbox"}) if dI[2] ==true then  YY998() end   lq = dI[1]  io.open("/sdcard/星辰阁配置文件.txt", "w") io.open("/sdcard/星辰阁配置文件.txt", "w"):write("✔️" .. lq .. "✔️"):close()
b=a 
...
function Main()  local sjbq=bqt[math.random(1,#bqt)] SY = gg.choice({
       [1] = sjbq.."𒅒🔰房主专区.星辰阁𒅒🔰"..sjbq,
    [2] = sjbq.."𒅒🔰联机专区.星辰阁𒅒🔰"..sjbq,
    [3] = sjbq.."𒅒🔰炸图专区.星辰阁𒅒🔰"..sjbq,
    [4] = sjbq.."𒅒🔰特效专区.星辰阁𒅒🔰"..sjbq,
    [5] = sjbq.."𒅒🔰狙击专区.星辰阁𒅒🔰"..sjbq,
    [6] = sjbq.."𒅒🔰️特别感谢.星辰阁𒅒🔰"..sjbq,
     [7] = sjbq.."𒅒🔰切换专区.星辰阁𒅒🔰"..sjbq,
      [8] = sjbq.."𒅒🔰音乐专区.星辰阁 𒅒🔰"..sjbq,
        [9] = sjbq.."𒅒🔰作者专区.星辰阁𒅒🔰"..sjbq,
        [10] = sjbq.."𒅒🔰科技专区.星辰阁𒅒🔰"..sjbq,
    [15] = sjbq.."𒅒🔰退出辅助.星辰阁𒅒🔰"..sjbq,
},2018,os.date("❤️御神阁群号:982461821北京时间%Y年%m月%d日%H时%M分%S秒🧊\n"))
...
o2= gg.choice({
    ...
    "𒅒🧊️鹿王本身🧊𒅒", 
     "𒅒🧊️精灵南瓜车🧊𒅒", 
      ...
      "𒅒🧊️虚空龙祖🧊𒅒",          
      "𒅒🧊️繁花夜明🧊𒅒", 
       "𒅒🎡返 回 主 页🎡𒅒",},2018,os.date("失去了太多....都不知道活着为了谁𒅒"))
...
function pl1()
gg.alert[[
许多人对我的评价很差，没有理由，我狂是我不想屈服，我以后会更新 可能有点慢，不过我保证每个功能都能用
]]
end
