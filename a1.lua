...
function Main()  local sjbq=bqt[math.random(1,#bqt)] SY = gg.choice({
       [1] = sjbq.."𒅒🔰开始炸图(联机)𒅒🔰"..sjbq,
         [2] = sjbq.."𒅒🔰PVP功能(通用)𒅒🔰"..sjbq,
    [6] = sjbq.."𒅒🔰播放音乐(放松)𒅒🔰"..sjbq,
       [3] = sjbq.."𒅒🔰漏洞功能(通用)𒅒🔰"..sjbq,
       [4] = sjbq.."𒅒🔰娱乐功能(通用)𒅒🔰"..sjbq,
       [5] = sjbq.."𒅒🔰关于辅助(作者)𒅒🔰"..sjbq,
    [7] = sjbq.."𒅒🔰退出辅助𒅒🔰"..sjbq,
},2018,os.date("️御神阁群号:982461821   \n🧊北京时间%Y年%m月%d日%H时%M分%S秒🧊\n当前迷你号:"..lq..""))
 if SY == nil then
    gg.toast("我爱你啊.....")
  end
...
"✨☀️玩法改创造✨☀️",
"✨☀️生存改创造✨☀️",
"(இωஇ)没钱 返 回 主 页 (இωஇ)没钱",
 }, nil, "🔶弄他妈的🔷，🔆目前此功能区:2个🔆")
if SN == nil then else
if SN[1]==true then     as8() end
if SN[2]==true then     as9() end
...
{["value"] = tt, ["type"] = 4},
{["lv"] = 0, ["offset"] = -4, ["type"] = 4},
{["lv"] = 1, ["offset"] = 0x14, ["type"] = 4},
}
qmxg = {
{["value"] = 0, ["offset"] = 0x14, ["type"] = 4},
}gg.clearList()
xqmnb(qmnb)
end
end
...
{["memory"] = 16384},
{["name"] = ""},
{["value"] =50971780, ["type"] = 4},
{["lv"] =50978312 , ["offset"] = 4, ["type"] = 4},
}
qmxg = {
{["value"]=3.0,["offset"]=152,["type"]=16},
}
xqmnb(qmnb)
 elseif F == 2 then
qmnb = {
...
作者:凉情城
出生日期:2007.4.14
做过的辅助:凉情-龙哥 凉情辅助por 星辰阁辅助 第七使徒辅助 LQ炸图辅助
性别:男
徒弟:柯南 夜辰 剑圣 恹梵
友好交往:ttp 重回巅峰
]]
